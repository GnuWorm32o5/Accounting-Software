...
class BillClass:
    def __init__(self, root):
        ...
        ProductFrame1 = Frame(self.root, bd=1, relief=GROOVE, bg="white")
        ProductFrame1.place(x=10,y=110, width=410,height=550)

        pTitle = Label(ProductFrame1, text="Svi proizvodi", font=("Segoe UI", 15), bd=2, relief=GROOVE, bg="white")
        pTitle.pack(side=TOP,fill=X)

        ProductFrame2 = Frame(ProductFrame1, bd=2, relief=GROOVE,bg="white")
        ProductFrame2.place(x=2,y=42,width=402,height=150)

        lbl_search=Label(ProductFrame2, text="Pretraga proizvoda | Po imenu ", font=("Segoe UI", 12), bd=2, relief=GROOVE, bg="white")
        lbl_search.place(x=75,y=5)

        lbl_name = Label(ProductFrame2, text="Ime proizvoda", font=("Segoe UI", 12), bd=2, relief=GROOVE, bg="white")
        lbl_name.place(x=25,y=40)

        # lbl_search = Label(ProductFrame2, font=("Segoe UI", 12), bd=2, relief=GROOVE, bg="white")
        ...
        ProductFrame3 = Frame(ProductFrame1, bd=3, relief="groove")
        # ProductFrame3.pack(side=BOTTOM, fill=X)
        ProductFrame3.place(x=15, y=190, width=380, height=300)
        ...
        self.ProductTable.heading("pid", text="Faktura", anchor=CENTER)
